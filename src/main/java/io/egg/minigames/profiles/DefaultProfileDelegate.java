...
public abstract class DefaultProfileDelegate {
    ...
    public void setInstance(InstanceContainer i ) {
        instance = i;
        defaultBar = BossBar.bossBar(Component.text("Please report this bar's existance!",TextColor.color(0xff00ff) ),  0.0f, BossBar.Color.WHITE, BossBar.Overlay.PROGRESS);
